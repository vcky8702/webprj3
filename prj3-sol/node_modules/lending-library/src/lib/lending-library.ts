...
export class LendingLibrary {
   ...
   *    BAD_REQ: invalid req
   */
  async findLendings(req: Record<string, any>)
    : Promise<Errors.Result<Lib.Lend[]>>
  {
    const findResult = Lib.validate<Lib.LendFind>('findLendings', req);
    if (!findResult.isOk) return findResult as Errors.Result<Lib.Lend[]>;
